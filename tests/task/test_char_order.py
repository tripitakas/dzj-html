...
class TestCharOrder(APITestCase):
    ...
    def _test_char_order_simple(self):
        r = self.fetch('/task/cut_proof/GL_924_2_35?step=char_order&_raw=1')
        self.assert_code(200, r)
        r = self.parse_response(r)
        self.assertIn('chars_col', r)
        r = self.parse_response(self.fetch('/task/cut_proof/GL_924_2_35?step=char_order&_raw=1&layout=2'))
