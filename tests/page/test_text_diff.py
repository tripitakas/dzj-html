...
class TestDiff(APITestCase):
    ...
    def test_page_diff(self):
        ...
        segments = PageTool.diff(ocr, ocr_col, cmp)
    ...
    def test_diff_api(self):
        txt1 = "說偈只這些兒住處是吾生長之地增加几个字別去三十七|年日月疾如彈指政和元年辛卯持缽至紹興七年丁巳計二十七年走遍|天下叢林意圖出離生死報答父母重恩不是等|閑遊戲平生得固剛強方與佛祖出氣今朝依旧|還鄉親戚百無一二道是昔人猶非道非昔人猶|是莫作是非論量透過世間出世慇懃普勸諸人|急著眼睛看取东持钵鄰郡訪雙槐居士鄭禹功|於璉市作佛燈珣禪師真讚金華聖者畫像讚題|吳氏六湛堂|八午|師五十歲乃入院之明年眾將一千皆諸方角立"
        txt2 = "說偈只這些兒住處是吾生長之地別去二十七年日月疾如彈指政和元年辛卯持缽至紹興七年丁巳計二十七年走遍天下叢林意圖出離生死報答父母重恩不是等閑遊戲平生得箇剛強方與佛祖出氣今朝依舊還鄉親戚百無一二道是昔人猶非道非昔人猶是莫作是非論量透過世間出世慇懃普勸諸人急著眼睛看取冬持缽鄰郡訪雙槐居士鄭禹功於璉市作佛燈珣禪師真讚金華聖者畫像讚題吳氏六湛堂八年戊午師五十歲乃入院之明年眾將一千皆諸方角立"
        hints = [{"block_no": 1, "line_no": 1, "base": "三", "cmp1": "二", "offset": "16"},
                 {"block_no": 1, "line_no": 4, "base": "固", "cmp1": "箇", "offset": "6"},
                 {"block_no": 1, "line_no": 4, "base": "旧", "cmp1": "舊", "offset": "18"}]
        r = self.fetch('/api/data/diff', body={'data': {'texts': [txt1, txt2], 'hints': hints}})
