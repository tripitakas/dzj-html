...
class TestTextPack(APITestCase):
    ...
    def _test_gen_segments_simple(self):
        """测试文字校对生成标记文本--基本测试"""
        s = PageTool.check_segments('卷北鿌沮渠蒙遜N', [])
        ...
        s = PageTool.check_segments('N \U0002e34f', [])  # GL_1056_5_6
        ...
        s = PageTool.check_segments('平等無傾囬邪自致𥼶氏云', [])  # GL_1260_4_8
    ...
    def _test_gen_segments_simple_chars(self):
        ...
        s = PageTool.check_segments('致𥼶氏 云', chars)
    ...
    def _test_gen_segments_mismatch_lines(self):
        ...
        if page:
            ...
            PageTool.check_segments(page['ocr'], page['chars'], params)
