...
from controller import com, data, task, page, tool, user, article, admin
from controller.com import invalid

views = com.views + data.views + tool.views + task.views
views += page.views + user.views + article.views + admin.views

handlers = com.handlers + data.handlers + tool.handlers + task.handlers
