...
url_placeholder = {
    ...
    'task_type': r'ocr_\w+|cut_\w+|txt_\w+|cluster_\w+|separate_\w+',
}
...
role_route_maps = {
    ...
    '工作人员': {
        ...
        'routes': {
            ...
            '/api/page/txt/diff': ['POST'],
            '/api/page/txt/detect_chars': ['POST'],
    ...
    '数据管理员': {
        ...
        'routes': {
            ...
            '/page/(admin|statistic)': ['GET'],
            '/page/(browse|info)/@page_name': ['GET'],
            '/api/page': ['POST'],
            '/api/page/(delete|source|export_char)': ['POST'],
            '/page/(box|order|cmp_txt|txt|char)/@page_name': ['GET'],
            '/page/(box|order|cmp_txt|txt|char)/edit/@page_name': ['GET'],
            '/api/page/(box|order|cmp_txt)/@page_name': ['POST'],
            '/char/(admin|browse|statistic)': ['GET'],
