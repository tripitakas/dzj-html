...
role_route_maps = {
    ...
    '切分校对员': {
        ...
        'routes': {
            ...
            '/api/task/cut_proof/@task_id': ['POST'],
    ...
    '切分审定员': {
        ...
        'routes': {
            ...
            '/api/task/cut_review/@task_id': ['POST'],
    ...
    '文字校对员': {
        ...
        'routes': {
            ...
            '/api/task/text_proof_@num/@task_id': ['POST'],
            '/data/edit/box/@page_name': ['GET'],
            '/api/data/edit/box/@page_name': ['POST'],
            '/api/data/unlock/box/@page_name': ['POST'],
    ...
    '文字审定员': {
        ...
        'routes': {
            ...
            '/api/task/text_review/@task_id': ['POST'],
            '/data/edit/box/@page_name': ['GET'],
            '/api/data/edit/box/@page_name': ['POST'],
            '/api/data/unlock/box/@page_name': ['POST'],
            '/api/data/unlock/text/@page_name': ['POST'],
    ...
    '文字专家': {
        ...
        'routes': {
            ...
            '/api/task/text_hard/@task_id': ['POST'],
