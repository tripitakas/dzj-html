...
task_locked = 3000, '本任务已被锁定，请领取新任务'
task_picked = 3001, '本任务已被领走，请领取新任务'
task_uncompleted = 3002, '您还有未完成的任务，请完成后再领取新任务'
task_changed = 3003, '本任务的状态已改变，请领取新任务'
task_none_to_pick = 3004, '目前没有新任务可领取，请关注任务动态'
task_unlocked = 3005, '本任务已被撤回，请领取新任务'
task_exceed_max = 3006, '超过上限'
task_cannot_pick = 3007, '本任务不能被领取'
task_text_proof_duplicated = 3008, '您已领取本页面的文字校对任务'
task_not_existed = 3009, '本任务不存在'
task_return_only_picked = 3010, '只能退回进行中的任务'

data_is_locked = 4001, '数据已经被其他人锁定'
data_lock_failed = 4002, '数据锁定失败'
data_unauthorized = 4003, '您没有没有本数据的权限'
