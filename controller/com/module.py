    ...
    def render(self, active_id=''):
        ...
        items = [
            ...
            dict(name='任务大厅', icon='icon-task-lobby', id='task-lobby', sub_items=[
                ...
                dict(name='难字处理', icon='icon-subitem', link='/task/lobby/text_hard'),
            ]),
            dict(name='我的任务', icon='icon-task-my', id='task-my', sub_items=[
                ...
                dict(name='难字处理', icon='icon-subitem', link='/task/my/text_hard'),
            ]),
            ...
            dict(name='系统管理', icon='icon-admin', id='admin', sub_items=[
                ...
                dict(name='操作日志', icon='icon-subitem', link='/admin/oplog'),
            ]),
