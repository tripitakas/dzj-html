    ...
    def render(self, title='', sub=''):
        ...
        items = [
            ...
            dict(name='任务管理', icon='icon_task_admin', id='task-admin', sub_items=[
                ...
                dict(name='文字校一', icon='icon_subitem', link='/task/admin/text_proof.1'),
                dict(name='文字校二', icon='icon_subitem', link='/task/admin/text_proof.2'),
                dict(name='文字校三', icon='icon_subitem', link='/task/admin/text_proof.3'),
