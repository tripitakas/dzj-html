...
class CommonLeft(UIModule):
    def render(self, title='', sub=''):
        ...
        items = [
            ...
            dict(name='如是藏经', icon='icon_temple', link='/tripitaka/rs'),
            ...
            dict(name='任务大厅', icon='icon_task_lobby', sub_items=[
                ...
                dict(name='文字校对', icon='icon_subitem', link='/task/lobby/block_cut_proof'),
            ...
            dict(name='我的任务', icon='icon_my_task', sub_items=[
                ...
                dict(name='文字校对', icon='icon_subitem', link='/task/my/block_cut_proof'),
            ...
            dict(name='任务管理', icon='icon_task_admin', sub_items=[
                ...
                dict(name='切字审定', icon='icon_subitem', link='/task/admin/char_cut_review'),
                dict(name='文字校对', icon='icon_subitem', link='/task/admin/text/status'),
