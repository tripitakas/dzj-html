...
op_types = {
    ...
    'submit_ocr': dict(name='OCR提交'),
    'submit_ocr_batch': dict(name='OCR批量导入'),
    'return_task': dict(name='退回任务'),
    'submit_task': dict(name='提交任务'),
    'publish_task': dict(name='发布任务'),
    'republish_task': dict(name='重新发布任务'),
    'assign_task': dict(name='指派任务'),
    'pick_task': dict(name='领取任务'),
    'delete_task': dict(name='删除任务'),
    'save_task': dict(name='任务保存'),
    'edit_task': dict(name='数据修改保存'),
    'save_{data_field}': dict(name='数据修改保存'),
    ...
    'add_user': dict(name='新增用户'),
    'update_user': dict(name='修改用户'),
