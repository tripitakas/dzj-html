...
(function () {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:URL.replace('static/editor/', '')+"php/imageUp.php"  //图片上传提交地址
        ,imagePath:URL.replace('static/editor/', '') + "upload/"          //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
...
//          ]
    ...
    ,whiteList: {
      a:      ['target', 'href', 'title', 'style', 'class', 'id', '_href'],
